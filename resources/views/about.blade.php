...
@section('content')
    ...
    <section class="feature py-5 bg-light">
        <div class="container text-center">
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="feature-item p-4 shadow-sm h-100 bg-white rounded-4 transition-all">
