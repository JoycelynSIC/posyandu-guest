...
<head>
    <meta charset="utf-8">
    <title>Posyandu Bina Desa</title>
                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-lg-7 animated fadeInLeft">
                            <div class="text-sm-center text-md-start">
                                ...
                                <p class="mb-5 fs-7">Posyandu adalah pusat pelayanan kesehatan dasar masyarakat yang fokus pada peningkatan kesehatan ibu, bayi, balita, dan lansia. 
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.2s">
                <div class="testimonial-item bg-light rounded">
                    <div class="row g-0">
                        <div class="col-4  col-lg-4 col-xl-3">
                            <div class="h-100">
                                <img src="{{ asset('assets/img/testimonial-1.jpg') }}" class="img-fluid h-100 rounded"
                ...
                <div class="testimonial-item bg-light rounded">
                    <div class="row g-0">
                        <div class="col-4  col-lg-4 col-xl-3">
                            <div class="h-100">
                                <img src="{{ asset('assets/img/testimonial-2.jpg') }}" class="img-fluid h-100 rounded"
                                    style="object-fit: cover;" alt="">
                            </div>
                        </div>
                        <div class="col-8 col-lg-8 col-xl-9">
                ...
                <div class="testimonial-item bg-light rounded">
                    <div class="row g-0">
                        <div class="col-4  col-lg-4 col-xl-3">
                            <div class="h-100">
                                <img src="{{ asset('assets/img/testimonial-3.jpg') }}" class="img-fluid h-100 rounded"
                                    style="object-fit: cover;" alt="">
                            </div>
                        </div>
                        <div class="col-8 col-lg-8 col-xl-9">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6 col-lg-6 col-xl-5">
                                <div class="footer-item">
                                    <a href="index.html" class="p-0">
                                        <h3 class="text-white"><i class="fab fa-slack me-3"></i> Posyandu</h3>
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-3">
                                <div class="footer-item">
                                    ...
                                    <a href="#"><i class="fas fa-angle-right me-2"></i> Fitur</a>
                                    <a href="#"><i class="fas fa-angle-right me-2"></i> Layanan</a>
                                    <a href="#"><i class="fas fa-angle-right me-2"></i> Pertanyaan Lainnya</a>
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-4">
                                <div class="footer-item">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-4">
                                            <div class="footer-instagram rounded">
                                                <img src="{{ asset('assets/img/instagram-footer-4.jpg') }}"
                                                    class="img-fluid w-100" alt="">
                                                <div class="footer-search-icon">
                                                    <a href="{{ asset('assets/img/instagram-footer-4.jpg') }}"
                                        ...
                                        <div class="col-4">
                                            <div class="footer-instagram rounded">
                                                <img src="{{ asset('assets/img/instagram-footer-5.jpg') }}"
                                                    class="img-fluid w-100" alt="">
                                                <div class="footer-search-icon">
                                                    <a href="{{ asset('assets/img/instagram-footer-5.jpg') }}"
                                        ...
                                        <div class="col-4">
                                            <div class="footer-instagram rounded">
                                                <img src="{{ asset('assets/img/instagram-footer-6.jpg') }}"
                                                    class="img-fluid w-100" alt="">
                                                <div class="footer-search-icon">
                                                    <a href="{{ asset('assets/img/instagram-footer-6.jpg') }}"
