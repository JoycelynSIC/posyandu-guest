...
@section('content')
    <div class="min-vh-100 d-flex align-items-center justify-content-center position-relative wow fadeIn"
        ...
        {{-- Background dekorasi --}}
        <div class="position-absolute top-0 start-0 w-100 h-100 wow fadeIn" style="
            background:
        ...
        <div class="card border-0 shadow-lg overflow-hidden wow fadeInUp" data-wow-delay="0.1s"
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6 d-flex flex-column justify-content-center align-items-center text-center p-5 wow fadeInLeft"
                    ...
                    <p class="small mb-3 opacity-90 wow fadeInUp" style="max-width:320px;line-height:1.6;">
                    ...
                    <div class="d-flex gap-2 wow fadeInUp">
                        ...
                        <span class="rounded-circle"
                            style="width:10px;height:10px;background:rgba(255,255,255,.35);"></span>
                    </div>
                </div>
                ...
                <div class="col-md-6 bg-white p-4 p-md-5 wow fadeInRight"
                    ...
                    @if ($errors->any())
                        <div class="alert alert-danger small wow fadeInDown">
                            <ul class="mb-0 ps-3">
                    ...
                    <form method="POST" action="{{ route('register.post') }}" class="wow fadeInUp">
                        ...
                        <div class="mb-2 wow fadeInUp">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" class="form-control bg-light border-0 rounded-end-pill py-2"
