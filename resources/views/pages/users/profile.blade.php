                ...
                <div class="card border-0 rounded-4 shadow-sm p-4 wow fadeInUp" data-wow-delay="0.2s"
                    ...
                    <div class="text-center mb-3">
                        <div class="position-relative d-inline-block">
                            <img src="{{ $user->profile_image ? asset('storage/' . $user->profile_image) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&background=random&rounded=true' }}"
                    ...
                    <div class="px-3 small">
                        ...
                        <div class="mb-2 d-flex justify-content-between">
                            <span class="text-muted"><i class="fa fa-calendar-alt me-2 text-primary"></i>Tanggal
                                Dibuat</span>
                            <span class="fw-semibold text-dark">{{ $user->created_at->format('d M Y') }}</span>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span class="text-muted"><i class="fa fa-sync-alt me-2 text-primary"></i>Terakhir
                                Diperbarui</span>
