...
<div class="py-4 bg-light d-flex justify-content-center">
    <div class="card shadow-sm border-0 rounded-4 p-3 wow fadeInUp" data-wow-delay="0.1s" style="max-width:600px;width:100%; background-color:#f9fafb;">
        ...
        <div class="text-center mb-3 wow fadeInDown" data-wow-delay="0.1s">
            ...
            <h5 class="fw-bold mt-2 mb-1 text-primary">{{ $posyandu->nama }}</h5>
            <p class="text-muted mb-1" style="font-size:0.8rem;">Informasi lengkap Posyandu</p>
        </div>

        <!-- Info Data dengan icon -->
        <div class="wow fadeInUp" data-wow-delay="0.2s">
            <p class="mb-1"><i class="fa fa-map-marker-alt me-1 text-primary"></i> <strong>Alamat:</strong> {{ $posyandu->alamat }}</p>
            <p class="mb-1"><i class="fa fa-home me-1 text-primary"></i> <strong>RT / RW:</strong> {{ $posyandu->rt }} / {{ $posyandu->rw }}</p>
            <p class="mb-1"><i class="fa fa-phone me-1 text-primary"></i> <strong>Kontak:</strong> {{ $posyandu->kontak }}</p>
            <hr class="my-2">
        </div>

        <!-- Dokumen / Foto Posyandu -->
        <h6 class="mb-2 wow fadeInUp" data-wow-delay="0.3s"><i class="fa fa-file-alt me-1 text-primary"></i> Dokumen / Foto Posyandu</h6>
                ...
                @foreach ($fotos as $index => $foto)
                    <div class="col-6 col-md-4">
                        <div class="border rounded p-1 text-center d-flex flex-column align-items-center justify-content-between"
                            ...
                            <p class="small text-truncate mb-1"><i class="fa fa-file me-1 text-primary"></i>{{ basename($foto->file_name) }}</p>
