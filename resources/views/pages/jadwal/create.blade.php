    ...
    <div class="py-3 bg-light d-flex justify-content-center">
        <div class="card shadow-sm border-0 rounded-4 wow fadeInUp" data-wow-delay="0.1s"
            ...
            <div class="card-body p-3">
                ...
                <!-- Form -->
                <form action="{{ route('jadwal.store') }}" method="POST" enctype="multipart/form-data" class="wow fadeInUp"
                    ...
                    <div class="mb-1">
                        ...
                        <select name="posyandu_id"
                            ...
                            @foreach ($posyandu as $p)
                                <option value="{{ $p->posyandu_id }}" {{ old('posyandu_id') == $p->posyandu_id ? 'selected' : '' }}>
                                    {{ $p->nama }}
                                </option>
                            @endforeach
                        </select>
