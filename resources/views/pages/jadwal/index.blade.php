    ...
    <div class="py-5 bg-light">
        <div class="container">
            ...
            <form method="GET" class="row g-3 mb-4 wow fadeInUp" data-wow-delay="0.2s">
                <div class="col-md-5">
                    <input type="text" name="search" class="form-control shadow-sm" placeholder="Cari tema / keterangan"
                ...
                <div class="col-12 d-flex gap-2 mt-2">
                    ...
                    @if(request('search') || request('posyandu_id'))
                        <a href="{{ route('jadwal.index') }}" class="btn btn-outline-primary shadow-sm rounded-pill flex-fill py-2 px-3 
...
@endauth
    ...
    @if(auth()->user()->role == 'admin')
        ...
        {{-- Hapus --}}
        <form action="{{ route('jadwal.destroy', $j->jadwal_id) }}" method="POST" class="m-0 p-0">
            @csrf
            @method('DELETE')
