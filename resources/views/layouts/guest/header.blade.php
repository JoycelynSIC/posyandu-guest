                    ...
                    @auth
                        @if(auth()->user()->role === 'admin')
                            <a href="{{ route('users.admin.index') }}"
                                ...
                                <i class="fas fa-user-shield text-primary me-1"></i> Manajemen Akun
                            </a>
                        @endif
                    @endauth
                    ...
                    @auth
                        <div class="nav-item dropdown">
                            <a href="#"
                                ...
                                {{ request()->is('warga*') || request()->is('posyandu*') || request()->is('kader*') || request()->is('jadwal*') || request()->is('imunisasi*') ? 'active' : '' }}"
